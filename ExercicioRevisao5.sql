Create DataBase ExercicioRevisao5
Go
Use ExercicioRevisao5
Go
...
Select Produto.quant, Sum(Produto.quant * valorU) As ValorTotal, Sum((Produto.quant * ValorU)*0.75) As ValorTotal_com_desconto
...
Where atividade = 'Brinquedo' and quant = 0

Update Produto 
Set valorU = valorU * 0.90
